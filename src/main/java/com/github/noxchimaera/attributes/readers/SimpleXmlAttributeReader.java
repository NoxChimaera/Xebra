...
public class SimpleXmlAttributeReader<TAttr> implements XmlAttributeReader<TAttr> {
    ...
    public <TObject> PinnedXmlAttributeReader<TObject, TAttr> pinned(BiConsumer<TObject, TAttr> setter) {
        return new PinnedXmlAttributeReader<TObject, TAttr>(this, setter);
    }
